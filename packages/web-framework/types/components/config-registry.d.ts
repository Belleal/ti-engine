...
export type ValidatorContext = {
    /**
     * (string): Promise<*>} getConfig Resolves the *pending* value of `key` when it is part of the
    ...
    : Function;
    /**
     * (string): Promise<*>} getStoredConfig Always resolves the current committed value of `key`,
