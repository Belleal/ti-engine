...
export type ExpressResponse = import("express").res;
export type ExpressHandler = (request: ExpressRequest, response: ExpressResponse, : Function) => void;
export type ExpressErrorHandler = (error: Error, request: ExpressRequest, response: ExpressResponse, : Function) => void;
