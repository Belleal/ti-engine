...
6. **`COMPETENCE_TEST_USER_ENABLED=true` on a hosted URL is only as safe as IAP.** If IAP were ever disabled, the deployment would let anyone act as any employee. INSTALL.md must state this as a hard coupling, not a soft recommendation.
